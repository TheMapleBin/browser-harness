...
Write-Output "  4. Run: powershell.exe -ExecutionPolicy Bypass -File `"$PSScriptRoot\install_zsclib_task_admin.ps1`" -WlanEventDelaySeconds 1 -LogonRetryIntervalMinutes 1 -LogonRetryDurationMinutes 5"
